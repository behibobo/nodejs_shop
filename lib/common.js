...
const restrictedRoutes = [
    ...
    {route: '/admin/option/new', response: 'redirect'},
    {route: '/admin/option/insert', response: 'redirect'},
    {route: '/admin/option/edit/:id', response: 'redirect'},
    {route: '/admin/option/update', response: 'redirect'},
    {route: '/admin/option/delete/:id', response: 'redirect'},
    {route: '/admin/option/published_state', response: 'json'},
    {route: '/admin/option/setasmainimage', response: 'json'},
    {route: '/admin/option/deleteimage', response: 'json'},

    {route: '/admin/brand/new', response: 'redirect'},
    {route: '/admin/brand/insert', response: 'redirect'},
    {route: '/admin/brand/edit/:id', response: 'redirect'},
    {route: '/admin/brand/update', response: 'redirect'},
    {route: '/admin/brand/delete/:id', response: 'redirect'},
    {route: '/admin/brand/published_state', response: 'json'},
    {route: '/admin/brand/setasmainimage', response: 'json'},
    {route: '/admin/brand/deleteimage', response: 'json'},

    {route: '/admin/category/new', response: 'redirect'},
    {route: '/admin/category/insert', response: 'redirect'},
    {route: '/admin/category/edit/:id', response: 'redirect'},
    {route: '/admin/category/update', response: 'redirect'},
    {route: '/admin/category/delete/:id', response: 'redirect'},
    {route: '/admin/category/published_state', response: 'json'},
    {route: '/admin/category/setasmainimage', response: 'json'},
    {route: '/admin/category/deleteimage', response: 'json'},
...
exports.indexBrands = (app) => {
    // index all products in lunr on startup
    return new Promise((resolve, reject) => {
        app.db.brands.find({}).toArray((err, brandsList) => {
            if(err){
                console.error(colors.red(err.stack));
                reject(err);
            }
            ...
            // setup lunr indexing
            const brandsIndex = lunr(function(){
              this.field('brandTitle', {boost: 10});
              this.field('brandPermalink', {boost: 10});
            ...
            app.brandsIndex = brandsIndex;
            console.log(colors.cyan('- Brand indexing complete'));
            resolve();
        });
    });
};

exports.indexCategories = (app) => {
    // index all products in lunr on startup
    return new Promise((resolve, reject) => {
        app.db.categories.find({}).toArray((err, categoriesList) => {
            if(err){
                console.error(colors.red(err.stack));
                reject(err);
            }
            ...
            const categoriesIndex = lunr(function(){
              this.field('catTitle', {boost: 10});
              this.field('catPermalink', {boost: 10});
            ...
            app.categoriesIndex = categoriesIndex;
            console.log(colors.cyan('- Categories indexing complete'));
            resolve();
        });
    });
};
